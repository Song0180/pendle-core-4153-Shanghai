...
export const consts = {
  ...
  SHIBASWAP_ROUTER_ADDRESS: '0x03f7724180AA6b939894B5Ca4314783B0b36b329',
  ...
  FORGE_SHIBASWAP: utils.formatBytes32String('Shibaswap'),
  ...
  INITIAL_SHIBA_TOKEN_AMOUNT: BN.from('171489293677797333'),
